                ...
                <div class="card-body pt-0 pb-0 h-100">
                  <div class="row g-0 h-100 align-content-center">
                    <div class="col-11 col-md-7 d-flex align-items-center mb-1 mb-md-0 order-1 order-md-1">
                      <a href="/panel/Results/{{$Result['uid']}}" class="body-link text-truncate">
                        <i data-acorn-icon="file-text" class="sw-2 me-2 text-alternate" data-acorn-size="17"></i>
                        <span class="align-middle">{{$Result['AppId']}}</span>
                      </a>
                    </div>
                    <div class="col-12 col-md-3 d-flex align-items-center text-muted order-3 order-md-2">{{$Result['create_at']}}</div>
                    <div class="col-1 col-md-2 d-flex align-items-center text-muted text-medium justify-content-end order-2 order-md-3">
                      <button onclick="DownloadFiles('{{$Result['Attachments']}}')" class="btn btn-icon btn-icon-only btn-link btn-sm p-1" type="button">
