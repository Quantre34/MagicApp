            ...
            if (data['outcome']) {
                ...
                Object.entries(data['data']).forEach( Item => {
                  console.log(Item);
                    ...
                    Item = value;
                    $('.ProductContainer').append(`<tr class="Product-Item" style="color:${Item['Status']=='1'? 'green' : 'red' }!important" title="${Item['Title']}"  >
                    <td>
                    <a href="/panel/Manage/Blog/${Item['uid']}"
                    ...
                    <td><label class="form-check mt-2">
                                      <input value="${Item['uid']}" name="Blogs[]" type="checkbox" class="form-check-input pe-none" />
                                    </label></td>
                  </tr>`);
                });
