            ...
            <div class="card-body">
              <div class="mb-4 d-flex align-items-center flex-column">
                <div class="sw-13 position-relative mb-3">
                  <img src="{{$Clinic['Logo']}}" class="img-fluid rounded-xl" alt="thumb" />
                </div>
                <div class="h5 mb-0">{{$Clinic['Title']}}</div>
                <!-- <div class="text-muted mb-2">Cardiology</div> -->
                <div class="text-muted text-center mb-2">{{$Clinic['Adress']}}</div>
                <div class="mb-3">
...
<!--                     <select class="rating" name="rating" autocomplete="off" data-readonly="true" data-initial-rating="5">
              ...
              <div class="row g-0 align-items-center mb-2">
                ...
                <div class="col ps-3">
                  <div class="d-flex align-items-center lh-1-25">{{$Clinic['Province']}}</div>
                </div>
              </div>
              <div class="row g-0 align-items-center mb-2">
                <div class="col-auto">
                ...
                <div class="col ps-3">
                  <div class="d-flex align-items-center lh-1-25">{{$Clinic['City']}}</div>
                </div>
              </div>
              <div class="row g-0 align-items-center mb-2">
                <div class="col-auto">
                    ...
                    <div class="h-100">
                      <div class="d-flex flex-column justify-content-start">
                        <div class="d-flex flex-column">
                          <a href="#" class="heading stretched-link">{{$Category['Title']}}</a>
                          @foreach($Clinic['Treatments'] as $Treatment)
                            @if($Treatment['ParentId'] == $Category['Id'])
                            <div class="text-alternate">{{$Treatment['Title']}}</div>
                            @endif
                          @endforeach
...
@section('script')
  <script src="{{URL::asset('assets/js/vendor/jquery.barrating.min.js')}}"></script>
    <script src="{{URL::asset('assets/js/pages/doctors.detail.js')}}"></script>
