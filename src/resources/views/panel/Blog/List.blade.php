        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Makaleler</h4>
...
<!--               <select class="form-select border fs-3" aria-label="Default select example">
              ...
              <a href="/panel/articles/new" class="btn btn-success d-flex align-items-center gap-1 fs-3 py-2 px-9">
                  ...
                  <table id="file_export" class="table w-100  table-bordered display text-wrap datatable">
                    ...
                    <tbody>
                      @foreach($Articles as $Article)
                        <tr>
                          <td> <img style="width: 50px;height: 50px;" src="{{$Article['Img']}}"> </td>
                          <td>{{$Article['Title']}}</td>
                          <td>{{$Article['Slug']}}</td>
                          <td class="hidden-xs" width="150">
                              <span class="badge  bg-<?= $Article['Status']=='1'? 'success' : 'danger' ?>-subtle text-<?= $Article['Status']=='1'? 'success' : 'danger' ?>"><?= $Article['Status']=='1'? 'Aktif' : 'Pasif' ?></span>
                          </td>
                          <td>
                             <a href="/panel/articles/{{$Article['uid']}}">
