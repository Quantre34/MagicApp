        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Makale Ekle</h4>
          ...
          <div class="card">
            <div class="card-body">
                ...
                <form id="ArticleForm" action="ajax" target="InsertArticle" method="POST" class="needs-validation" novalidate>
                    ...
                    <textarea hidden id="text-area" name="Content"></textarea>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Kategori</label>
                      <select class="form-select"  name="Type">
                        <option value="0">Panel</option>
                        <option   value="1">Websitesi</option>
                      </select>
                    </div>
                    <div class="mb-1">
