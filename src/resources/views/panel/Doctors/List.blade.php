        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Doktorlar</h4>
...
<!--               <select class="form-select border fs-3" aria-label="Default select example">
              ...
              <a href="/panel/website/doctors/new" class="btn btn-success d-flex align-items-center gap-1 fs-3 py-2 px-9">
                  ...
                  <table id="file_export" class="table w-100  table-bordered display text-wrap datatable">
                    ...
                    <tbody>
                      @foreach($Doctors as $Doctor)
                        <tr>
                          <td> <img style="width: 50px;height: 50px;" src="{{$Doctor['Img']}}"> </td>
                          <td>{{$Doctor['Title']}}</td>
                          <td>{{$Doctor['Info']}}</td>
                          <td class="hidden-xs" width="150">
                              <span class="badge  bg-{{ $Doctor['Status']=='1'? 'success' : 'danger' }}-subtle text-{{ $Doctor['Status']=='1'? 'success' : 'danger' }}">{{ $Doctor['Status']=='1'? 'Aktif' : 'Pasif' }}</span>
                          </td>
                          <td>
                             <a href="/panel/website/doctors/{{$Doctor['uid']}}">
