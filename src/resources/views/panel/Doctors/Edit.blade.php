        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Doktor Düzenle</h4>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                  <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="/panel/categories">Doktor</a>
                  </li>
                  <li class="breadcrumb-item active" aria-current="page">{{$Doctor['Title']}}</li>
                </ol>
              </nav>
            </div>
            <div class="d-flex align-items-center justify-content-between gap-6">
              <a href="/panel/doctors" class="text-warning d-flex align-items-center ">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                    ...
                    <div class="col-sm-8 col-md-9 col-lg-10">
                      <center>
                        <div style="width: 100%;"  class="col-auto">
                          <div sclass="sw-5 me-3">
                          <div class="mx-auto">
                              <img id="Cover" onclick="javascript:$('input[type=file][name=Cover]').click();" src="{{$Doctor['Img'] ?? '/assets/img/Default-Package.jpg'}}" style="width: 100%;max-width: 400px;" alt="thumb">
                          </div>
                ...
                <form action="ajax" target="AlterDoctor" method="POST" class="needs-validation" novalidate>
                  
                    <input type="text" hidden required name="uid" value="{{$Doctor['uid']}}" >
                    <input type="text" hidden required name="Img" value="{{$Doctor['Img']}}" >

                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Başlık</label>
                      <input type="text" name="Title" required class="form-control" id="exampleInputtext1" value="{{$Doctor['Title']}}" >
                    </div>
                    <div class="mb-1 col " style="display: flex;padding: 20px;">
                      ...
                      <input  style="max-width: 80%;" type="text" name="Path" required class="form-control col-8" id="exampleInputtext1" value="{{$Doctor['Path']}}">
                    ...
                    <div class="mb-1">
                      ...
                      <input type="text" name="Info" required class="form-control" id="exampleInputtext1" value="{{$Doctor['Info']}}" >
                    </div>
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                      ...
                      <select class="form-select" required name="Status">
                        <option {{$Doctor['Status']=='0'?'selected' : ''}} value="0">Pasif</option>
                        <option {{$Doctor['Status']=='1'?'selected' : ''}} value="1">Aktif</option>
                      </select>
                    </div>
