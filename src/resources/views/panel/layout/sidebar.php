      ...
      <div>
        <div class="brand-logo d-flex align-items-center">
          <a href="" class="text-nowrap logo-img">
            <img src="assets/panel/images/logos/dark-logo.svg" alt="Logo" class="dark-logo" />
            <img src="assets/panel/images/logos/light-logo.svg" alt="Logo" class="light-logo" />
          </a>
        </div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
          <ul class="sidebar-menu" id="sidebarnav">
            ...
            <li>
              ...
              <div class="user-profile text-center position-relative pt-4 mt-1">
                ...
                <div class="profile-img m-auto">
                  <img src="assets/panel/images/profile/user-1.jpg" alt="user" class="w-100 rounded-circle" />
                </div>
                <!-- User profile text-->
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-calendar.html"><iconify-icon icon="solar:calendar-mark-line-duotone"></iconify-icon>
                <span class="hide-menu">Calendar</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-kanban.html"><iconify-icon icon="solar:airbuds-case-minimalistic-line-duotone"></iconify-icon>
                <span class="hide-menu">Kanban</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-chat.html"><iconify-icon icon="solar:chat-round-line-line-duotone"></iconify-icon>
                <span class="hide-menu">Chat</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-email.html"><iconify-icon icon="solar:letter-line-duotone"></iconify-icon>
                <span class="hide-menu">Email</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-notes.html"><iconify-icon icon="solar:document-text-line-duotone"></iconify-icon>
                <span class="hide-menu">Notes</span>
              </a>
            </li>

            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-contact.html"><iconify-icon icon="solar:iphone-line-duotone"></iconify-icon>
                <span class="hide-menu">Contact Table</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-contact2.html"><iconify-icon icon="solar:phone-line-duotone"></iconify-icon>
                <span class="hide-menu">Contact List</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/app-invoice.html"><iconify-icon icon="solar:bill-list-line-duotone"></iconify-icon>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="../main/layout-inner-left-sidebar.html" class="sidebar-link">
                    <span class="icon-small"></span>
                    <span class="hide-menu">Inner Left Sidebar</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="../main/layout-inner-right-sidebar.html" class="sidebar-link">
                    <span class="icon-small"></span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/form-basic.html">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/chart-sparkline.html">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../main/authentication-maintenance.html">
