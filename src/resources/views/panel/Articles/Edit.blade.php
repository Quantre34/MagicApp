        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Makale Düzenle</h4>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                  <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="/panel/articles">Makaleler</a>
                  </li>
          ...
          <div class="card">
            <div class="card-body">
                ...
                <form id="ArticleForm" action="ajax" target="AlterArticle" method="POST" class="needs-validation" novalidate>
                  
                    <input type="text" hidden required name="Img" value="{{$Article['Img']}}">
                    ...
                    <div class="mb-1">
                      ...
                      <input type="text" name="Title" required class="form-control" id="exampleInputtext1" value="{{$Article['Title']}}" >
                    </div>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Url Anahtarı</label>
                      <input type="text"  name="Slug" required class="form-control" id="exampleInputtext1" value="{{$Article['Slug']}}">
                    </div>
                    <div class="mb-1 row" >
                    ...
                    <textarea hidden id="text-area" name="Content">{{$Article['Content']}}</textarea>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Kategori</label>
                      <select class="form-select"  name="Type">
                        <option {{$Article['Type']=='0'? 'Selected' : ''}} value="0">Panel</option>
                        <option  {{$Article['Type']=='1'? 'Selected' : ''}} value="1">Websitesi</option>
                      </select>
                    </div>
                    <div class="mb-1">
