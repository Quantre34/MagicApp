        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Acente Ekle</h4>
          ...
          <div class="card">
            <div class="card-body">
                  ...
                  <div class="col-sm-8 col-md-9 col-lg-10">
                    <center>
                      <div style="width: 100%;"  class="col-auto">
                        ...
                        <div class="mx-auto">
                            <img id="Logo" onclick="javascript:$('input[type=file][name=Logo]').click();" src="/assets/img/Default-Package.jpg" style="width: 100%;max-width: 200px;" alt="thumb">
                        </div>
                ...
                <form id="InsertAgency" action="ajax" target="InsertAgency" method="POST" class="needs-validation" novalidate>
                  
                    <input type="text" hidden required name="Logo" value="">
                    ...
                    <div class="mb-1">
                      ...
                      <input type="text"  name="Whatsapp" required class="form-control" id="exampleInputtext1" >
                    </div>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Instagram</label>
                      <input type="text"  name="Instagram" class="form-control" id="exampleInputtext1" >
                    </div>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Websitesi</label>
                      <input type="text"  name="WebPage" class="form-control" id="exampleInputtext1" >
                    </div>
                     <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">VatNumber</label>
                      <input type="text"  name="VatNumber" class="form-control" id="exampleInputtext1">
                    </div>
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                      ...
                      <select class="form-select" required name="ParentId" <?= User('Type')=='1'? 'disabled': '' ?>>
                          @foreach($Managers as $Manager)
                              <option <?= User('uid')==$Manager['uid']? 'selected': '' ?> value="{{$Manager['uid']}}">{{$Manager['FirstName']}} {{$Manager['LastName']}}</option>
                          @endforeach                        
                      </select>
                    </div>
                    ...
                    <div class="mb-1">
                      ...
                      <input type="text"  name="CommissionRate" class="form-control" id="exampleInputtext1" >
                    </div>
                    <div class="mb-1">
      ...
      @section('script')
        ...
        <script type="text/javascript">
          ...
          function FileUploaded(url){
            $('#Logo').attr('src', url);
            $('#InsertAgency input[name=Logo]').val(url);
          }
