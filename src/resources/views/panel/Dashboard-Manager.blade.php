      ...
      <div class="page-title-container">
        <div class="row">
          ...
          <div class="col-12 col-md-7">
            <span class="align-middle text-muted d-inline-block lh-1 pb-2 pt-2 text-small">Panel</span>
            <h1 class="mb-0 pb-0 display-4" id="title">@Lang('ManagerDashboard.Hello'), {{User('FirstName')}}</h1>
            ...
            <div class="dropdown-as-select me-3" data-setActive="false" data-childSelector="span">
              ...
              <div class="dropdown-menu font-standard">
                <div class="nav flex-column" role="tablist">
                  <a class="active dropdown-item text-medium" href="#" aria-selected="true" role="tab">@Lang('ManagerDashboard.Recent')</a>
<!--                   <a class="dropdown-item text-medium" href="#" aria-selected="false" role="tab">Tomorrow's</a>
            ...
            <h2 class="small-title">@Lang('ManagerDashboard.Weekly') </h2>
          </div>
<?php $i = 0; ?>
@foreach($AllAppointments as $key => $Appointment)
  @if(date('Y-m-d', strtotime($Appointment['AppointmentDate'])) >= date('Y-m-d') && date('Y-m-d', strtotime($Appointment['AppointmentDate'])) <= date('Y-m-d', strtotime('+7 days')) )
    <div class="card mb-2">
  ...
  <div class="card mb-2">
    <div class="card-body py-3">
      <label class="form-check custom-icon mb-0 checked-line-through checked-opacity-75 mt-2">
        ...
        <span class="form-check-label">
          <span class="content">
            <span class="mb-1 lh-1-25">@Lang('ManagerDashboard.NoAppointments')</span>
...
@endif
        ...
        <div class="col-xl-6 mb-5">
          <h2 class="small-title">@Lang('ManagerDashboard.Schedule')</h2>
...
$(document).ready(function(){
  GetAppointments();
      ...
      <div class="d-flex justify-content-between">
        <h2 class="small-title">@Lang('ManagerDashboard.Stats')</h2>
        @if(User('Type')=='2')
          <button class="btn btn-icon btn-icon-end btn-xs btn-background-alternate p-0 text-small" type="button">
            <span class="align-bottom">@Lang('ManagerDashboard.AddCategories')</span>
...
?>
        ...
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">@Lang('ManagerDashboard.WeeklyTotal') </p>
              <div class="text-extra-small fw-medium text-muted">{{$WeeklyCost}}</div>
            </a>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">@Lang('ManagerDashboard.WeeklyProfit')</p>
              <div class="text-extra-small fw-medium text-muted">{{$WeeklyProfit}}</div>
            </a>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">@Lang('ManagerDashboard.MonthlyTotal')</p>
              <div class="text-extra-small fw-medium text-muted">{{$MonthlyCost}}</div>
            </a>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">@Lang('ManagerDashboard.MonthlyProfit')</p>
              <div class="text-extra-small fw-medium text-muted">{{$MonthlyProfit}}</div>
            </a>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">@Lang('ManagerDashboard.SubManagers')</p>
              <div class="text-extra-small fw-medium text-muted">{{count($SubManager ?? [])}}</div>
            </a>
          </div>
        </div>
          ...
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">@Lang('ManagerDashboard.Agencies')</p>
              <div class="text-extra-small fw-medium text-muted">{{count($Agencies ?? [])}}</div>
            </a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-xl-6 mb-5">
          <h2 class="small-title">@Lang('ManagerDashboard.AppointmentsByAgencies')</h2>
          <div class="card">
            <div class="card-body">
              <div class="sh-35">
        ...
        <div class="col-xl-6 mb-5">
          <h2 class="small-title">@Lang('ManagerDashboard.AppointmentsByStatus')</h2>
          <div class="card">
            <div class="card-body">
              <div class="sh-35">
            ...
            <div class="card h-100">
              <div class="card-body">
                <div class="text-center">
                  ...
                  <div class="d-flex flex-column sh-5">
                    <a href="/panel/Guidebook" class="heading stretched-link">{{Lang::get('Base.CheckTheGuidebook')}}</a>
                  </div>
                </div>
                <div class="text-muted text-center">
...
@section('script')
    ...
    $(document).ready(function(){
      setTimeout(function(){
        @foreach($Agencies as $Agency)
          @if($Agency['Status']=='1')
            addData(window.SalesChart, "{{$Agency['Title']}}", parseInt({{count($Agency['AllAppointments'])}}) );
          @endif
        @endforeach
      }, 500);
      ...
      $o = 0;
      foreach($Agencies as $Agency){
        foreach($Agency['AllAppointments'] as $Appointment){
    ...
    setTimeout(function(){
    addData(window.StatusChart, "@Lang('ManagerDashboard.Active')", {{$i}} );
    addData(window.StatusChart, "@Lang('ManagerDashboard.OnHold')", {{$o}} );
    }, 500);
    </script>
