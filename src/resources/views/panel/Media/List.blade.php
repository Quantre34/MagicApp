                      ...
                      @foreach($Media as $Item)
                        <tr>
                          ...
                          <td class="hidden-xs" width="150">
                              <span class="badge  bg-{{ $Item['Status']=='1'? 'success' : 'danger' }}-subtle text-{{ $Item['Status']=='1'? 'success' : 'danger' }}">{{ $Item['Status']=='1'? 'Aktif' : 'Pasif' }}</span>
                          </td>
                          <td>
                             <a href="/panel/website/media/{{$Item['uid']}}">
