        ...
        <div class="container-fluid">
          <div class="d-md-flex align-items-center justify-content-between mb-7">
            <div class="mb-4 mb-md-0">
              <h4 class="fs-6 mb-0">Media Düzenle</h4>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                    ...
                    <div class="col-sm-8 col-md-9 col-lg-10">
                      <center>
                        <div style="width: 100%;"  class="col-auto">
                          <div sclass="sw-5 me-3">
                          <div class="mx-auto">
                              <img id="Cover" onclick="javascript:$('input[type=file][name=Cover]').click();" src="{{$Media['Img'] ?? '/assets/img/Default-Package.jpg'}}" style="width: 100%;max-width: 400px;" alt="thumb">
                          </div>
                ...
                <form action="ajax" target="AlterMedia" method="POST" class="needs-validation" novalidate>
                  
                    <input type="text" hidden required name="uid" value="{{$Media['uid']}}" >
                    <input type="text" hidden required name="Img" value="{{$Media['Img']}}" >

                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Başlık</label>
                      <input type="text" name="Title" required class="form-control" id="exampleInputtext1" value="{{$Media['Title']}}" >
                    </div>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Türü</label>
                      <select class="form-select" required name="Type">
                        <option {{$Media['Type']=='0'?'selected' : ''}} value="0">Fotoğraf</option>
                        <option {{$Media['Type']=='1'?'selected' : ''}} value="1">Vide</option>
                      </select>
                    </div>
                    <div class="mb-1 col " style="display: flex;padding: 20px;">
                      ...
                      <input  style="max-width: 80%;" type="text" name="Path" required class="form-control col-8" id="exampleInputtext1" value="{{$Media['Path']}}">
                    ...
                    <div class="mb-1">
                      ...
                      <textarea class="form-control" name="Info">{{$Media['Info']}}</textarea>
                    </div>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Anasayfada Görünsün</label>
                      <select class="form-select" required name="FadeInHome">
                        <option {{$Media['FadeInHome']=='0'?'selected' : ''}} value="0">Hayır</option>
                        <option {{$Media['FadeInHome']=='1'?'selected' : ''}} value="1">Evet</option>
                      </select>
                    </div>
                    <div class="mb-1">
                      <label for="exampleInputtext1" class="form-label">Durum</label>
                      <select class="form-select" required name="Status">
                        <option {{$Media['Status']=='0'?'selected' : ''}} value="0">Pasif</option>
                        <option {{$Media['Status']=='1'?'selected' : ''}} value="1">Aktif</option>
                      </select>
                    </div>
