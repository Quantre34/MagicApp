...
<!-- header1 -->
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="video-wrapper slide-video ratio"><video autoplay muted width="400" height="400"
                            ...
                            data-src="/uploads/2022/12/njmjek.mp4">
                            <source src="uploads/2022/12/njmjek.mp4" type="video/mp4"></video></div>
                    <div class="wrapper">
                        <div class="container">
                            <div class="content">
                                ...
                                <a href="sherbimet.html" title="Learn More" class="rounded-pill btn btn-primary"> Learn More<svg class="cvzicon">
                        ...
                        <script type="application/ld+json">
                            {
                                ...
                                "@type": "ImageObject",
                                "author": "A Doctor",
                                "contentUrl": "/uploads/2024/06/slider-mobile-rhinoplasty-hotel-campaign.jpg"
                            }
                        </script>
                    </div>
                    <div class="wrapper">
                        <div class="container">
                            <div class="content">
                                ...
                                <a href="estetike.html" title="Learn More" class="rounded-pill btn btn-primary"> Learn More<svg class="cvzicon">
                                    <use xlink:href="assets/img/icons.svg#chevron-right-light"></use>
                                </svg></a>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="video-wrapper slide-video ratio"><video autoplay muted width="400" height="400"
                            class="home-video lazy-video" playsinline preload="none" loop
                            data-src="/uploads/2023/05/ngushtimi-stomakut-slider-video.mp4">
                    ...
                    <div class="wrapper">
                        <div class="container">
                            <div class="content">
                                ...
                                <a href="services-obezitet.html" title="Learn More" class="rounded-pill btn btn-primary"> Learn More<svg class="cvzicon">
                                    <use xlink:href="assets/img/icons.svg#chevron-right-light"></use>
                                </svg></a>
                            </div>
                        </div>
                ...
                <div class="swiper-slide" data-swiper-autoplay="5000">
                    <div class="img-wrapper ratio">
                        <picture>
                            ...
                            <img  src="assets/img/slider-4.webp" width="100%" height="100%" class="w-100 h-100 of-cover" data-transform-origin="0% 0% 0px" alt="Professional Services and Reliability" title="Professional Services and Reliability"></picture>
                        <script type="application/ld+json">
                            {
                                "@context": "https://schema.org",
                                "@type": "ImageObject",
                                "author": "A Doctor",
                                "contentUrl": "/uploads/2024/04/hand-leg-protez-mobile-slider.webp"
                            }
                        </script>
                    </div>
                    <div class="wrapper">
                        <div class="container">
                            <div class="content">
                                <div class="title-1">Professional Services and Reliability</div>
                                <div class="title-2">
                                    <p class="title-2">Hand and Leg Prosthetics</p>
                                </div>
                                <p>Continue living your life as before with hand and leg prosthetics</p> 
                                <a href="proteze-e-dores-dhe-e-kembes.html" title="Learn More" class="rounded-pill btn btn-primary"> Learn More<svg class="cvzicon">
                                    <use xlink:href="assets/img/icons.svg#chevron-right-light"></use>
                                </svg></a>
                            </div>
                        </div>
                        ...
                        <script type="application/ld+json">
                            {
                                ...
                                "@type": "ImageObject",
                                "author": "A Doctor",
                                "contentUrl": "/uploads/2024/04/robotic-physical-therapy-mobile-slider.webp"
                            }
                        </script>
                    </div>
                    <div class="wrapper">
                            ...
                            <div class="swiper madde-thumbs-swiper d-block d-md-none">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a title="Our Patients" role="button" class="changeSlide mb-3 d-block" data-index="1">
                                            <div class="icon rounded-circle w-40px h-40px p-2">
                                                <img data-src="/uploads/2023/05/flag.webp" alt="Our Patients" title="Our Patients">
                                            </div>
                                            <div class="title">Our Patients</div>
                                            <p class="mb-1">Some of our patients have shared moments from their experience with our organization and the treatment they received in our partner hospitals.</p>
                                        </a>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" data-index="1">
                                        <figure class="ratio ratio-16x9">
                                            <a href="https://www.youtube.com/watch?v=rMyi94Z2JcE" data-fslightbox>
                                                <img src="assets/img/home-banner-1.webp" class="w-100 h-100 of-cover" alt="Our Patients" title="Our Patients">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="swiper-slide" data-index="2">
                                        <figure class="ratio ratio-16x9">
                                            <a href="uploads/2024/03/k-kampanya-01-al.webp" data-fslightbox>
                                                <img data-src="/uploads/2024/03/k-kampanya-01-al.webp" class="w-100 h-100 of-cover" alt="Special Offers" title="Special Offers">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="swiper-slide" data-index="3">
                                        <figure class="ratio ratio-16x9">
                                            <a href="https://wa.me/+905415573736" target="_blank" rel="noopener">
                                                <img src="assets/img/home-banner-2.webp" class="w-100 h-100 of-cover" alt="Free Consultation" title="Free Consultation">
                                            </a>
                                        </figure>
                                    </div>
                                </div>
                        ...
                        <div class="row g-2 g-lg-4">
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="icon rounded-circle w-45px h-45px p-2"><img
                                                data-src="/uploads/2022/09/7-01.svg" alt="We Organize Everything">
                                        </div>
                            ...
                            <div class="col-xs-6 col-lg-4 ">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="icon rounded-circle w-45px h-45px p-2"><img
                                                data-src="/uploads/2022/09/8-01.svg" alt="24/7 Support"></div>
                            ...
                            <div class="col-xs-6 col-lg-4 ">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="icon rounded-circle w-45px h-45px p-2"><img
                                                data-src="/uploads/2022/09/6-01.svg" alt="No Additional Costs"></div>
                            ...
                            <div class="col-xs-6 col-lg-4 d-lg-none d-block">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="icon rounded-circle w-45px h-45px p-2"><img
                                                data-src="/uploads/2022/09/3-01-1.svg" alt="Premium Hospitals in Turkey">
                                        </div>
        ...
        <div class="home-services pt-4 py-lg-5 py-xl-6 pt-xl-3">
            <div class="container">
                <div class="home-services__top d-flex justify-content-between align-items-center mb-lg-4">
                    <div class="header-1">
                        <p class="mb-0"><span>Get to Know Us Better!</span>
                            <div class="title"><span class="fw-semi-bold fs-normal text-primary d-inline-block">One
                                    Doctor</span> Services</div>
                        </p>
                    </div>
                </div>
                <div class="row g-2 g-xl-4">
                    <div class="col-sm-6 col-lg-4">
                        <div class="service-item">
                            <figure class="mb-0 ratio ratio-1x1">
                                <img
                                    src="assets/img/doctor-service-1.webp"
                                ...
                                <script type="application/ld+json">
                                    {
                                        ...
                                        "@type": "ImageObject",
                                        "author": "One Doctor",
                                        "contentUrl": "/uploads/2023/05/doctor-hand-holding-stethoscope-closeup.webp"
                                    }
                                </script>
                            </figure>
                            <p>
                                <div class="title"><span>MEDICINE</span></div>
                            </p>
                            <div class="overlay"><span class="d-block">MEDICINE</span><a href="medical-units.html"
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="service-item">
                            <figure class="mb-0 ratio ratio-1x1"><img
                                    src="assets/img/doctor-service-2.webp"
                                    class="w-100 h-100 of-cover" alt>
                                <script type="application/ld+json">
                                    {
                                        "@context": "https://schema.org",
                                        "@type": "ImageObject",
                                        "author": "One Doctor",
                                        "contentUrl": "/uploads/2023/05/k-aesthetic-web-homepage-kopya.webp"
                                    }
                                </script>
                            </figure>
                            <p>
                                <div class="title"><span>AESTHETICS</span></div>
                            </p>
                            <div class="overlay"><span class="d-block">AESTHETICS</span><a href="aesthetics.html"
                                    class="stretched-link btn btn-white rounded-circle p-0 w-50px h-50px"><svg
                                        class="cvzicon">
                                        <use xlink:href="assets/img/icons.svg#arrow-right-solid"></use>
                                    </svg></a></div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="service-item">
                            <figure class="mb-0 ratio ratio-1x1"><img
                                    src="assets/img/doctor-service-3.webp"
                                    class="w-100 h-100 of-cover" alt>
                                <script type="application/ld+json">
                                    {
                                        "@context": "https://schema.org",
                                        "@type": "ImageObject",
                                        "author": "One Doctor",
                                        "contentUrl": "/uploads/2023/05/k-obesity-web-homepage-kopya.webp"
                                    }
                                </script>
                            </figure>
                            <p>
                                <div class="title"><span>OBESITY</span></div>
                            </p>
                            <div class="overlay"><span class="d-block">OBESITY</span><a href="obesity-services.html"
                                    class="stretched-link btn btn-white rounded-circle p-0 w-50px h-50px"><svg
                                        class="cvzicon">
                                        <use xlink:href="assets/img/icons.svg#arrow-right-solid"></use>
                                    </svg></a></div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="unit-item my-3 mx-2">
                                ...
                                <figure>
                                    <img src="assets/img/ıvf.webp" alt="IVF" width="218" height="218">
                                </figure>
                            </div>
                        </div>
                        <div class="swiper-slide">
    ...
    <div class="home-aesthetic pt-3 py-lg-4">
        <div class="container">
            <div class="header-2 mb-lg-4">
                <div class="title">
                    <span class="fw-semi-bold fs-normal text-primary d-inline-block">A Doctor's</span> Aesthetics
                </div>
            ...
            <div class="row g-3 g-lg-4">
                <div class="col-xs-6 col-lg-3">
                    <div class="aesthetic-cat-item">
                        ...
                        <div class="content">
                            ...
                            <ul>
                                <li><a href="liposuksion.html" title="Liposuction"> Liposuction</a></li>
                                <li><a href="palosje-e-barkut.html" title="Abdominal Tummy Tuck"> Abdominal Tummy Tuck</a></li>
                                <li><a href="ngritje-e-kraheve.html" title="Arm Lift"> Arm Lift</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-lg-3">
                    <div class="aesthetic-cat-item">
                        <figure class="ratio ratio-16x9">
                            <img data-src="/uploads/2024/03/facial-small-background.webp" class="w-100 h-100 of-cover" alt="Facial Aesthetics">
                        </figure>
                        <div class="content">
                            <div class="title">
                            ...
                            <ul>
                                <li><a href="estetik-e-hundes.html" title="Nose Aesthetics"> Nose Aesthetics</a></li>
                                <li><a href="ngritja-e-vetullave-1.html" title="Eyebrow Lift"> Eyebrow Lift</a></li>
                                <li><a href="ngritja-e-fytyr-s.html" title="Face Lift"> Face Lift</a></li>
                                <li><a href="estetik-e-veshit.html" title="Ear Aesthetics"> Ear Aesthetics</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-lg-3">
                    <div class="aesthetic-cat-item">
                        <figure class="ratio ratio-16x9">
                            <img data-src="/uploads/2024/03/dentistry-2-small-background.webp" class="w-100 h-100 of-cover" alt="Dentistry">
                        </figure>
                        <div class="content">
                            <div class="title">
                            ...
                            <ul>
                                <li><a href="implant-dentar.html" title="Dental Implants"> Dental Implants</a></li>
                                <li><a href="veshje-me-zircon.html" title="Zircon Crowns"> Zircon Crowns</a></li>
                                <li><a href="zbardhja-e-dh-mb-ve.html" title="Teeth Whitening"> Teeth Whitening</a></li>
                                <li><a href="dh-mb-ur.html" title="Dental Bridges"> Dental Bridges</a></li>
                                <li><a href="dizajni-i-buz-qeshjes.html" title="Smile Design"> Smile Design</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-lg-3">
                    <div class="aesthetic-cat-item">
                        <figure class="ratio ratio-16x9">
                            <img data-src="/uploads/2024/03/hair-transplant-small-background.webp" class="w-100 h-100 of-cover" alt="Hair">
                        </figure>
                        <div class="content">
                            <div class="title">
                            ...
                            <ul>
                                <li><a href="transplant-i-flok-ve-fue.html" title="FUE Hair Transplant"> FUE Hair Transplant</a></li>
                                <li><a href="transplant-i-flok-ve-dhi.html" title="DHI Hair Transplant"> DHI Hair Transplant</a></li>
                                <li><a href="transplant-i-flok-ve-safir.html" title="SAFIR Hair Transplant"> SAFIR Hair Transplant</a></li>
                                <li><a href="transplant-i-mjekr-s-dhe-mustaqeve.html" title="Beard and Mustache Transplant"> Beard and Mustache Transplant</a></li>
                                <li><a href="transplant-i-vetullave.html" title="Eyebrow Transplant"> Eyebrow Transplant</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="step-by-step pt-4 py-xl-5">
        <div class="container">
            <div class="header-2 mb-lg-5">
                <div class="title">Step by Step A Doctor's</div>
    ...
    <section class="home-videos pt-4">
        <div class="container">
            <div class="header-2 mb-lg-4 d-flex flex-column flex-lg-row justify-content-between align-items-lg-center align-items-start gap-2 w-100">
                ...
                <a href="video-galeria.html" title="View All" class="text-decoration-underline fw-semi-bold"> View All</a>
            </div>
            <div class="swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="height: unset">
                        <div class="video-item m-3" style="height: calc(100% - 2rem)">
                            <figure class="ratio ratio-16x9"><img src="assets/img/video-gal-1.jpg" class="w-100 h-100 of-cover" alt="Emotional Experience - Salihu hears for the first time after receiving Cochlear Implant in Turkey"></figure>
                            <div class="content"><a href="https://www.youtube.com/watch?v=10gco_zo7ns" rel="noopener external" data-fslightbox="video" class="title stretched-link" title="Emotional Experience - Salihu hears for the first time after receiving Cochlear Implant in Turkey">Emotional Experience - Salihu hears for the first time after receiving Cochlear Implant in Turkey</a><a href="https://www.youtube.com/watch?v=10gco_zo7ns" class="play ms-3" aria-label="Emotional Experience - Salihu hears for the first time after receiving Cochlear Implant in Turkey"><svg class="cvzicon"><use xlink:href="assets/img/icons.svg#play-video"></use></svg></a></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="height: unset">
                        <div class="video-item m-3" style="height: calc(100% - 2rem)">
                            <figure class="ratio ratio-16x9"><img src="assets/img/video-gal-2.jpg" class="w-100 h-100 of-cover" alt="STEM CELLS - Treatment of Rare Diseases with Stem Cells"></figure>
                            <div class="content"><a href="https://www.youtube.com/watch?v=cyWiNNLAVQs" rel="noopener external" data-fslightbox="video" class="title stretched-link" title="STEM CELLS - Treatment of Rare Diseases with Stem Cells">STEM CELLS - Treatment of Rare Diseases with Stem Cells</a><a href="https://www.youtube.com/watch?v=cyWiNNLAVQs" class="play ms-3" aria-label="STEM CELLS - Treatment of Rare Diseases with Stem Cells"><svg class="cvzicon"><use xlink:href="assets/img/icons.svg#play-video"></use></svg></a></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="height: unset">
                        <div class="video-item m-3" style="height: calc(100% - 2rem)">
                            <figure class="ratio ratio-16x9"><img src="assets/img/video-gal-3.jpg" class="w-100 h-100 of-cover" alt="Another Wonderful Result of Stomach Shrinking | Meet Kreshnik!"></figure>
                            <div class="content"><a href="https://www.youtube.com/watch?v=_flNCynL-LY" rel="noopener external" data-fslightbox="video" class="title stretched-link" title="Another Wonderful Result of Stomach Shrinking | Meet Kreshnik!">Another Wonderful Result of Stomach Shrinking | Meet Kreshnik!</a><a href="https://www.youtube.com/watch?v=_flNCynL-LY" class="play ms-3" aria-label="Another Wonderful Result of Stomach Shrinking | Meet Kreshnik!"><svg class="cvzicon"><use xlink:href="assets/img/icons.svg#play-video"></use></svg></a></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="height: unset">
                        <div class="video-item m-3" style="height: calc(100% - 2rem)">
                            <figure class="ratio ratio-16x9"><img src="assets/img/video-gal-4.jpg" class="w-100 h-100 of-cover" alt="We Are Close"></figure>
                            <div class="content"><a href="https://www.youtube.com/watch?v=TIqe7QzwH7M" rel="noopener external" data-fslightbox="video" class="title stretched-link" title="We Are Close">We Are Close</a><a href="https://www.youtube.com/watch?v=TIqe7QzwH7M" class="play ms-3" aria-label="We Are Close"><svg class="cvzicon"><use xlink:href="assets/img/icons.svg#play-video"></use></svg></a></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="height: unset">
                        <div class="video-item m-3" style="height: calc(100% - 2rem)">
                            <figure class="ratio ratio-16x9"><img src="assets/img/video-gal-4.jpg" class="w-100 h-100 of-cover" alt="Pediatric Oncology - Rejani Returns Healthy and Safe to His Homeland"></figure>
                            <div class="content"><a href="https://www.youtube.com/watch?v=TZs8KMbZ-q4" rel="noopener external" data-fslightbox="video" class="title stretched-link" title="Pediatric Oncology - Rejani Returns Healthy and Safe to His Homeland">Pediatric Oncology - Rejani Returns Healthy and Safe to His Homeland</a><a href="https://www.youtube.com/watch?v=TZs8KMbZ-q4" class="play ms-3" aria-label="Pediatric Oncology - Rejani Returns Healthy and Safe to His Homeland"><svg class="cvzicon"><use xlink:href="assets/img/icons.svg#play-video"></use></svg></a></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="height: unset">
                        <div class="video-item m-3" style="height: calc(100% - 2rem)">
                            <figure class="ratio ratio-16x9"><img src="assets/img/video-gal-5.jpg" class="w-100 h-100 of-cover" alt="Arsimi showed courage and took the first step to overcome obesity!"></figure>
                            <div class="content"><a href="https://www.youtube.com/watch?v=xxgbPqqXGEY" rel="noopener external" data-fslightbox="video" class="title stretched-link" title="Arsimi showed courage and took the first step to overcome obesity!">Arsimi showed courage and took the first step to overcome obesity!</a><a href="https://www.youtube.com/watch?v=xxgbPqqXGEY" class="play ms-3" aria-label="Arsimi showed courage and took the first step to overcome obesity!"><svg class="cvzicon"><use xlink:href="assets/img/icons.svg#play-video"></use></svg></a></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="height: unset">
                        <div class="video-item m-3" style="height: calc(100% - 2rem)">
                            <figure class="ratio ratio-16x9"><img src="assets/img/video-gal-6.jpg" class="w-100 h-100 of-cover" alt="Another Wonderful Result of Stomach Shrinking | Meet Ferdja!"></figure>
                            <div class="content"><a href="https://www.youtube.com/watch?v=_RHGaPLtsCk" rel="noopener external" data-fslightbox="video" class="title stretched-link" title="Another Wonderful Result of Stomach Shrinking | Meet Ferdja!">Another Wonderful Result of Stomach Shrinking | Meet Ferdja!</a><a href="https://www.youtube.com/watch?v=_RHGaPLtsCk" class="play ms-3" aria-label="Another Wonderful Result of Stomach Shrinking | Meet Ferdja!"><svg class="cvzicon"><use xlink:href="assets/img/icons.svg#play-video"></use></svg></a></div>
                        </div>
                    </div>
                </div>
                <div class="swiper-button-prev"></div>
    ...
    <section class="home-before-after pt-4">
        <div class="container">
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/para-pas-obezitet.html"
                                class="ratio ratio-1x1 d-block"><img
                                    src="assets/img/foto-gal-1.jpg" class="w-100 h-100 of-cover"
                                    alt="Para & Pas Obezitet"></a></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/trajtimet-me-nj-mjek-1.html"
                                class="ratio ratio-1x1 d-block"><img
                                    data-src="/uploads/2024/04/treatments-web-cover.webp" class="w-100 h-100 of-cover"
                                    alt="Trajtimet me Një Mjek"></a></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/para-pas-operacion-i-skolioz-s.html"
                                class="ratio ratio-1x1 d-block"><img
                                   src="assets/img/foto-gal-3.jpg"
                                    class="w-100 h-100 of-cover" alt="Para & Pas Operacion i Skoliozës"></a></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/abdomenoplastik.html"
                                class="ratio ratio-1x1 d-block"><img
                                    data-src="/uploads/2024/04/abdominoplasty-web-cover.webp"
                                    class="w-100 h-100 of-cover" alt="Abdomenoplastik"></a></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/para-pas-mebjella-e-flok-ve.html"
                                class="ratio ratio-1x1 d-block"><img
                                   src="assets/img/foto-gal-5.jpg"
                                    class="w-100 h-100 of-cover" alt="Para & Pas Mebjella e Flokëve"></a></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/para-pas-rimodelimi-i-vesh-ve.html"
                                class="ratio ratio-1x1 d-block"><img
                                   src="assets/img/foto-gal-6.jpg"
                                    class="w-100 h-100 of-cover" alt="Para & Pas Rimodelimi i Veshëve"></a></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/para-pas-abdominoplastik.html"
                                class="ratio ratio-1x1 d-block"><img
                                    data-src="/uploads/2024/04/abdo-para-pas-web-cover.webp"
                                    class="w-100 h-100 of-cover" alt="Para & Pas Abdominoplastik"></a></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="image-item"><a href="foto-galeria/kancerin-e-gjirit.html"
                                class="ratio ratio-1x1 d-block"><img
                                    data-src="/uploads/2024/04/breast-cancer-web-cover.webp"
                                    class="w-100 h-100 of-cover" alt="Kanceri i Gjirit"></a></div>
                    </div>
                </div>
                <div class="swiper-button-prev"></div>
                <div class="swiper-button-next"></div>
    ...
    <section class="showcase-blogs pt-4">
        <div class="container">
            <div class="header-2 mb-lg-5 d-flex flex-column flex-lg-row justify-content-between align-items-lg-center align-items-start gap-3 w-100">
                <div class="l-side">
                    <div class="title"><span class="fw-semi-bold fs-normal text-primary d-inline-block">NjëMjek </span> Medical Articles</div>
                    <p>For more similar articles click <a href="blog.html" title="here" class="fw-bold">here</a></p>
                </div>
            </div>
            <div class="row gy-lg-4 gy-2">
                <div class="col-lg-6">
                    <div class="showcase-blog-item ratio first"><img data-src="/uploads/2023/05/diabetes-njemjek-1.webp" alt="Type 2 Diabetes">
                        <div class="title">Type 2 Diabetes</div><a href="blog/type-2-diabetes.html" title="Type 2 Diabetes" aria-label="Type 2 Diabetes"></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row gy-lg-4 gy-2">
                        <div class="col-lg-12 col-md-6">
                            <div class="showcase-blog-item ratio ratio-21x9"><img data-src="/uploads/2023/05/rosi-ivf-njemjek.webp" alt="ROSI Technique in IVF">
                                <div class="title">ROSI Technique in IVF</div><a href="blog/rosi-technique-in-ivf.html" title="ROSI Technique in IVF" aria-label="ROSI Technique in IVF"></a>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-6">
                            <div class="showcase-blog-item ratio ratio-21x9"><img data-src="/uploads/2024/07/hyperbaric-therapy-ft2-765x310.jpg" alt="Hyperbaric Oxygen Chambers (HBOC)">
                                <div class="title">Hyperbaric Oxygen Chambers (HBOC)</div><a href="blog/hyperbaric-oxygen-chambers-hboc.html" title="Hyperbaric Oxygen Chambers (HBOC)" aria-label="Hyperbaric Oxygen Chambers (HBOC)"></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="feedback-item">
                                        <div class="image mb-3">
                                            <img data-src="/uploads/2024/05/emoj-m_small.jpg" class="w-100 h-100 of-cover" alt="Bedri Rexha">
                                        </div>
                                        <div class="name mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="feedback-item">
                                        <div class="image mb-3">
                                            <img data-src="/uploads/2024/05/emoj-m-1_small.jpg" class="w-100 h-100 of-cover" alt="Besnik Alili">
                                        </div>
                                        <div class="name mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="feedback-item">
                                        <div class="image mb-3">
                                            <img data-src="/uploads/2024/05/emoj-m-2_small.jpg" class="w-100 h-100 of-cover" alt="Skender Selmani">
                                        </div>
                                        <div class="name mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="feedback-item">
                                        <div class="image mb-3">
                                            <img data-src="/uploads/2024/04/elvis-rrashiti_small.PNG" class="w-100 h-100 of-cover" alt="Elvis Rrashi">
                                        </div>
                                        <div class="name mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="feedback-item">
                                        <div class="image mb-3">
                                            <img data-src="/uploads/2024/07/eralda-shala_small.PNG" class="w-100 h-100 of-cover" alt="Eralda Shala">
                                        </div>
                                        <div class="name mb-3">
    ...
    <div class="home-offer pt-4 py-xl-5">
        <div class="container">
            ...
            <form action="https://www.njemjek.com/ajax/offer" method="POST" class="offer-form no-ajax">
                ...
                <div class="row g-lg-4 g-2">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="tel" name="phone" class="form-control rounded-pill" placeholder="Phone">
                    </div>
                ...
                <div class="row mt-0 mt-lg-4 gy-lg-3 gy-2 align-items-center">
                    <div class="col-xxl-3 col-lg-5">
                        <div class="file w-100">
                            ...
                            <button type="button" class="fileselect" title="Upload File">
                                <svg class="cvzicon">
                    ...
                    <div class="col-12">
                        <div class="g-recaptcha mb-4" data-sitekey="6LdGKZ8pAAAAAB0CgnIK8W0WeZnhrNYvqTligNIl"></div>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="container">
            <div class="row g-lg-4 g-2 justify-content-around align-items-center">
                <div class="col-sm-auto col-12 stats-item" style="min-height: 80px">
                    <figure><img data-src="/uploads/2023/05/stats-icon-01.webp" alt="Years of Experience"></figure>
                ...
                <div class="col-sm-auto col-12 stats-item" style="min-height: 80px">
                    <figure><img data-src="/uploads/2022/09/4-01-1.svg" alt="Happy Patients"></figure>
                    <div class="right-side d-flex align-items-center">
                ...
                <div class="col-sm-auto col-12 stats-item" style="min-height: 80px">
                    <figure><img data-src="/uploads/2022/09/3-01-1.svg" alt="Partner Hospitals"></figure>
                    <div class="right-side d-flex align-items-center">
                ...
                <div class="col-sm-auto col-12 stats-item" style="min-height: 80px">
                    <figure><img data-src="/uploads/2022/09/2-01-1.svg" alt="Qualified Doctors"></figure>
                    <div class="right-side d-flex align-items-center">
        ...
        <div class="container">
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="link-item">
                            <div class="ratio ratio-4x3 image"><img data-src="/uploads/2024/03/memorial-hospital.webp" alt="Memorial Hospital"></div>
                            <div class="content shadow-sm">
                    ...
                    <div class="swiper-slide">
                        <div class="link-item">
                            <div class="ratio ratio-4x3 image"><img data-src="/uploads/2024/03/medipol-hospital.webp" alt="Medipol Hospital"></div>
                            <div class="content shadow-sm">
                    ...
                    <div class="swiper-slide">
                        <div class="link-item">
                            <div class="ratio ratio-4x3 image"><img data-src="/uploads/2024/03/gurgan-clinic-ivf-clinic-center-njemjek.webp" alt="Gürgan Clinic"></div>
                            <div class="content shadow-sm">
                    ...
                    <div class="swiper-slide">
                        <div class="link-item">
                            <div class="ratio ratio-4x3 image"><img data-src="/uploads/2024/03/biruni-njemjek.webp" alt="Biruni University Hospital"></div>
                            <div class="content shadow-sm">
