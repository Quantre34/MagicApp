...
@section('content')
  <main>
    <div class="container">
      ...
      <div class="page-title-container">
        <div class="row">
          ...
          <div class="col-12 col-md-7">
            ...
            <h1 class="mb-0 pb-0 display-4" id="title">Good morning, Faruk!</h1>
          </div>
          <!-- Title End -->
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-6 mb-5">
          <div class="d-flex">
            ...
            <h2 class="small-title">Clients</h2>
          </div>
          <div class="card mb-2">
        ...
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">Hair restoration</p>
              <div class="text-extra-small fw-medium text-muted">3 Clinics</div>
            </a>
          </div>
        </div>
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">Dental Treatments</p>
              <div class="text-extra-small fw-medium text-muted">5 Clinics</div>
            </a>
          </div>
        </div>
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">Plastic Surgery</p>
              <div class="text-extra-small fw-medium text-muted">2 Clinics</div>
            </a>
          </div>
        </div>
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">Eye Treatments</p>
              <div class="text-extra-small fw-medium text-muted">4 Clinics</div>
            </a>
          </div>
        </div>
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">Obesity Treatment</p>
              <div class="text-extra-small fw-medium text-muted">2 Clinics</div>
            </a>
          </div>
        </div>
        <div class="col-6 col-md-4 col-xl-2 sh-23">
          <div class="card h-100 hover-scale-up">
            <a class="card-body text-center d-flex flex-column align-items-center" href="#">
              ...
              <p class="heading mt-3 text-body">Orthopedic Surgery</p>
              <div class="text-extra-small fw-medium text-muted">6 Clinics</div>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xl-6 mb-5">
          <h2 class="small-title">Clients by Age</h2>
          <div class="card">
            <div class="card-body">
              <div class="sh-35">
        ...
        <div class="col-xl-6 mb-5">
          <h2 class="small-title">Clients by Gender</h2>
          <div class="card">
            <div class="card-body">
              <div class="sh-35">
